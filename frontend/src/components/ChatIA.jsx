...
import { Send, Loader, User, Bot, Zap, FileText } from 'lucide-react';

/**
 * 🎯 ChatIA.jsx - INTEGRADO CON MULTI-IA PILI_QUARTS
 * 
...
const ChatIA = ({
  ...
  useEffect(() => {
    ...
    addMessage(
      `**PILi_Quarts: The World's First Cognitive Document Orchestrator.** ⚡
      
Beyond simple automation—we engineer success from Quote to Delivery. While others merely draft, PILi manages the entire lifecycle with military precision and luxury aesthetics.
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-gray-900 text-sm font-medium">
                {servicioActual.nombre} • Cognitive Document Orchestrator
              </p>
            </div>
          </div>
