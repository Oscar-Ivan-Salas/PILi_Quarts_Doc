...
class ExcelGenerator:
    ...
    def generar_cotizacion_simple(self, datos: Dict[str, Any], ruta_salida: str) -> str:
        """
        Genera Cotización Simple usando el motor SOBERANO N04.
        """
        logger.info("🎯 ExcelGenerator: Usando Motor SOBERANO N04 para Cotización Simple")
        return self._render_and_convert("cotizacion_simple", datos, ruta_salida)
